...
type: poem
order: 12
source: 'projects/fletcher-complete-original-collections/transcription/volumes/01_early_works/books/02_the_dominant_city_1911_1912/poems/012_tragic_night.md'
---
...
The poem is a sonnet printed solid in the source and left solid here: its single long sentence pours across the eighth line without pausing, and to break it at the octave would give the poem a rest it clearly refuses to take. The octave is interlocked on two rhymes (abab baba); the sestet runs cdcd ee.
