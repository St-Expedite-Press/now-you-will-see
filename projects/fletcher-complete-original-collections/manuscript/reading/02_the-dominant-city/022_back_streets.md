...
type: poem
order: 22
source: 'projects/fletcher-complete-original-collections/transcription/volumes/01_early_works/books/02_the_dominant_city_1911_1912/poems/022_back_streets.md'
---
...
Coarse, deathless, changeless!  Do you homage
  render
...
The source prints the sonnet solid; the editorial text divides it at l. 9 ('Thousands of years ago thus in the grime'), where the sestet pulls the view back to show the same struggle in the same grime across all of recorded time. The octave commands homage to the city's deathless life; the sestet provides the evidence. Petrarchan sonnet, octave abbaabba, sestet cde cde.
