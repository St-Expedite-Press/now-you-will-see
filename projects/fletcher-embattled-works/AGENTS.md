# fletcher-embattled-works — Project AGENTS

**Volume 3 of *John Gould Fletcher: The Complete Original Collections*** —
*The Embattled Works* (1921–1928, four books). **Scaffold:** transcription not yet begun (metadata only). No reading edition or buildable
interior yet.
...
- Transcription witnesses (where present) live in `transcription/volumes/03_embattled_works/books/<book>/poems/`.
...
```
texgraph verify-coverage --project fletcher-embattled-works      # every transcription poem maps to a built reading poem
texgraph proof-build      --project fletcher-embattled-works      # once reading/ is populated
```
