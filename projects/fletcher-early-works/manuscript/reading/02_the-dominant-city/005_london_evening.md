...
type: poem
order: 5
source: 'projects/fletcher-early-works/transcription/volumes/01_early_works/books/02_the_dominant_city_1911_1912/poems/005_london_evening.md'
---
...
I would think, grey one, that your rain was my
  grief:
...
L. 14 ('I would think, grey one, that your rain was my grief') makes the projection explicit: London's rain is the speaker's sorrow cast outward. The poem is structured as two octaves, not a sonnet: the first rhymes at long range (abcd ebcd), the echo arriving half-forgotten, which suits a 'dream-tapestry'; the second settles into plain alternation as the apostrophe turns direct.
