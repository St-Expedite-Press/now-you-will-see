...
- `machinery/docs/ONTOLOGY.md` — comprehensive repo reference: directory taxonomy, schemas, commands, invariants
- `machinery/docs/README.md` — documentation index
- `machinery/docs/PROJECT_OVERVIEW.md` — full project overview
...
- `machinery/tools/` — cross-module infrastructure scripts
- `projects/<project_id>/` — local full-module project body (gitignored except tracked examples)
- `machinery/docs/PERSONA.md` — editorial voice contract template for generative prose
- root `README.md`, `ONTOLOGY.md`, `HANDOFF.md`, `CLAUDE.md`, and `PERSONA.md` — compatibility stubs only
...
4. When directory structure, schemas, CLI commands, or pipeline edges change:
   run `machinery/tools/ontology_check.py` and update `machinery/docs/ONTOLOGY.md` before committing.
5. Keep `AGENTS.md` lean — routing table and loops only. Detail lives in `machinery/docs/ONTOLOGY.md`.
6. Keep persona instructions in `machinery/docs/PERSONA.md`; do not duplicate them in plans or metadata.
...
10. After any significant repo change, run the ontology checker and save a new baseline
    when `machinery/docs/ONTOLOGY.md` has been updated. See `machinery/skills/technical-docs/SKILL.md`.
