...
Usage:
    python machinery/tools/harvest_sessions.py            # harvest most recent session
    python machinery/tools/harvest_sessions.py --update   # re-harvest most recent (new turns)
    python machinery/tools/harvest_sessions.py --all      # harvest all sessions
    python machinery/tools/harvest_sessions.py --all --update
    python machinery/tools/harvest_sessions.py --list
    python machinery/tools/harvest_sessions.py --session <id>
...
After harvesting:
    ...
    4. Run: python machinery/tools/build_dataset.py
"""
...
def main() -> int:
    ...
    print("Then: python machinery/tools/build_dataset.py")
    return 0
