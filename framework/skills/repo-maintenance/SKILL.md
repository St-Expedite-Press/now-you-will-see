...
- `framework/skills/` — cross-module infrastructure workflow programs
...
7. Keep tool instructions in `framework/skills/tooling/SKILL.md` and module `AGENTS.md` files.
...
10. After any significant repo change, run the ontology checker and save a new baseline
    when `README.md` has been updated. See `framework/skills/technical-docs/SKILL.md`.
