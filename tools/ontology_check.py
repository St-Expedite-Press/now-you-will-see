...
Usage:
    python tools/ontology_check.py
    python tools/ontology_check.py --since <git-ref>
    python tools/ontology_check.py --save-baseline
"""
...
REVIEW_NOTES: dict[str, str] = {
    ...
    "skills": "Skill & Tool Loading Contract / Skill & Tool Index — regenerate with `python tools/skill_index.py --write`",
...
def check(root: Path, since: str | None) -> int:
    ...
    print("  Update README.md, then run:")
    print("  python tools/ontology_check.py --save-baseline")
    return 1
