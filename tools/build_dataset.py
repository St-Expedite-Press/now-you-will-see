...
Usage:
    ...
    python tools/build_dataset.py --output logs/dataset/
    python tools/build_dataset.py --split 0.9
    python tools/build_dataset.py --include-failures
    python tools/build_dataset.py --only-subagents
...
def main() -> int:
    ...
    print("  python tools/build_dataset.py --no-metadata")
